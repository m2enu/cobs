 ...
 */
#ifndef TEST_COBS_H_INCLUDED
#define TEST_COBS_H_INCLUDED

/**
 * @brief       Original data 6
 */
#define ORG_DATA_6      {                                                                                           \
